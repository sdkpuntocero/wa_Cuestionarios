(function($) {
  ...
  $(function() {
    var dataBar = {
        labels: ["Biología", "Español", "Filosofía", "Física", "Geografía", "Historia México", "Historia Universal", "Literatura", "Matemáticas", "Química"],
      datasets: [{
        label: 'Customers',
    ...
    var webAudienceMetricsSatackedData = {
        labels: ["Bio", "Esp", "Fil", "Fis", "Geo", "H Mex", "H Uni", "Lit", "Mat", "Qui"],
      datasets: [
        {
          label: 'Sessions',
